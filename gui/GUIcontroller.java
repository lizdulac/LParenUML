...
//              System.out.println("U-NODE: drag");
    ...
    public EventHandler<ActionEvent> saveFile = new EventHandler<ActionEvent> ()
    {
        ...
        public void handle (ActionEvent e)
        {
            ...
            File file = fc.showSaveDialog(theView.stage);
            fileIO.save (file);
        }
    };
    ...
    public EventHandler<ActionEvent> openFile = new EventHandler<ActionEvent> ()
    {
        ...
        public void handle (ActionEvent e)
        {
            ...
            File file = fc.showOpenDialog (theView.stage);
            fileIO.open (file);
        }
    };
    ...
    public EventHandler<MouseEvent> selectEdge = new EventHandler<MouseEvent> ()
    {
        @Override
        public void handle (MouseEvent e)
        {
