...
public class GUIview
{
    ...
    public GUIview (GUIcontroller aController, Stage aStage)
    {
        ...
        aStage.setTitle ("LParen - UML Diagram Editor");
        aStage.initStyle (StageStyle.valueOf ("UNIFIED"));
        try {
            aStage.getIcons ().add (new Image ("LParen.jpg"));
        } catch (Exception e) {}
   ...
   */
    private MenuBar createMenuBar(Stage aStage)
    {
        ...
        MenuItem newF = new MenuItem("New");
         ...
         open.setOnAction(controller.openFile);
         save.setOnAction (controller.saveFile);
         newF.setOnAction (controller.newFile);
    ...
    public void endEdgeDraw(Pane srcNode, Line theEdge, Point2D releasePoint)
    {
        ...
        theEdge.setOnMouseClicked (controller.selectEdge);
    }
