   ...
   public void refreshVNode(Integer id, String name)
   {
    ...
    private void configureSideStage (BorderPane borderPane)
    {
     ...
     // sideStage
        ...
        ((Button) ((Pane) ((Pane) anchorPane.getChildren ().get (1)).getChildren ().get (1)).getChildren ().get (7))
                .setOnAction (e -> toggleSlider (((Pane) anchorPane.getChildren ().get (0))));
        
        // PrintStats button triggers ModelUtil.printStats()
        ((Button) ((Pane) ((Pane) anchorPane.getChildren ().get (1)).getChildren ().get (1)).getChildren ().get (8))
